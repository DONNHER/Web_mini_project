                ...
                <div class="hidden md:flex items-center space-x-2">
                    ...
                    @auth
                        ...
                        <div class="relative" x-data="{ notificationsOpen: false }">
                            <button type="button" @click.stop="notificationsOpen = !notificationsOpen" class="p-2 text-[#1A1A1A]/40 hover:text-[#FF6B00] transition relative cursor-pointer group">
                                ...
                                <span id="notification-count" class="hidden absolute top-1.5 right-1.5 bg-[#FF6B00] text-white text-[7px] font-black px-1 py-0.5 rounded-full ring-2 ring-white pointer-events-none">0</span>
                            </button>

                            <div x-show="notificationsOpen" @click.outside="notificationsOpen = false" x-cloak x-transition class="absolute right-0 mt-4 w-80 bg-white border border-[#FFEDD5] rounded-2xl shadow-2xl z-50 overflow-hidden">
