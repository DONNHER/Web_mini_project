...
@section('header')
    <div class="flex items-center space-x-6">
        ...
        <div>
            <span class="text-[#FF6B00] font-black uppercase tracking-[0.4em] text-[10px] mb-1 block">Registry Refactor</span>
            <h1 class="text-4xl font-black text-[#1A1A1A] uppercase tracking-tighter">Configure <span class="text-[#FF6B00]">Identity</span></h1>
        </div>
    </div>
@endsection
            ...
            <form action="{{ route('admin.users.update', $user) }}" method="POST" class="space-y-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div>
                        ...
                        <select name="role_id" id="role_id" class="w-full bg-[#FEF6F0] border-none rounded-2xl py-4 font-bold focus:ring-4 focus:ring-[#FF6B00]/5 text-sm mt-3">
                    ...
                    <div>
                        ...
                        <select name="status" id="status" class="w-full bg-[#FEF6F0] border-none rounded-2xl py-4 font-bold focus:ring-4 focus:ring-[#FF6B00]/5 text-sm mt-3">
