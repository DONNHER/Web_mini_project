...
@section('title', 'AI Risk Assessment Log Detail')

@section('header')
    <h2 class="font-semibold text-xl text-blue-400 leading-tight">
        AI Risk Analysis Detail #{{ $log->id }}
    </h2>
@endsection
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 shadow-xl overflow-hidden">
                <div class="p-6 border-b border-gray-700 bg-gray-900">
                    <h3 class="text-lg font-bold text-white flex items-center">
                        ...
                        AI Reasoning & Credit Assessment
                    </h3>
                </div>
                <div class="p-6 space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="bg-gray-900 p-4 rounded-lg border border-gray-700">
                            <span class="text-xs text-gray-500 uppercase font-bold">Assessment Type</span>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 shadow-xl overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    @if($log->resource_type == 'Loan')
                        <a href="{{ route('loans.show', $log->resource_id) }}" class="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded transition">
                            View Loan Details
                        </a>
                    @endif
                    ...
                    <div>
                        <span class="text-xs text-gray-500 uppercase font-bold">AI Provider</span>
            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 shadow-xl p-6">
                <h3 class="text-sm font-bold text-gray-400 uppercase mb-4">Risk Probability</h3>
                ...
                <p class="text-xs text-gray-500 text-center">
                    Higher percentage indicates higher probability of credit default or fraud.
                </p>
            </div>
        </div>
    </div>
