            ...
            <div class="max-w-md w-full" x-data="{ showPassword: false }">
                ...
                <div class="mt-12">
                    <div class="relative flex items-center justify-center mb-8">
                        ...
                        <span class="relative px-6 bg-[#FEF6F0] text-[9px] font-black text-black/20 uppercase tracking-[0.3em]">New to PIL?</span>
                    </div>
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" class="w-full flex items-center justify-center py-4 border-2 border-black/5 hover:border-[#FF6B00]/30 hover:bg-white rounded-2xl text-[10px] font-black text-black uppercase tracking-widest no-underline transition-all shadow-sm">
